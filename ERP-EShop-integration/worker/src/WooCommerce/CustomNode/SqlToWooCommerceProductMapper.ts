...
import { IOutput as IInput } from '../../Sql/Batch/ListAllStocks';

export const NAME = 'sql-to-woo-commerce-product-mapper';

export default class SqlToWooCommerceProductMapper extends ACommonNode {
